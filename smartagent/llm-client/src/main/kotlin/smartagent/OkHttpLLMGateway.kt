...
class OkHttpLLMGateway(
    ...
    override fun chat(messages: List<Message>, model: ModelConfig, source: String, options: OllamaOptions?): LLMGateway.Response? {
        ...
        val requestBody = json.encodeToString(ChatRequest(model.apiModelId, cleanMessages, temperature = model.temperature, options = options, reasoningEffort = model.reasoningEffort))
